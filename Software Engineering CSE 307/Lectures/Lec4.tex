...
\end{itemize}
\subsection{Software safety benefits}
\begin{itemize}
...
\end{itemize}
\newpage
\subsection{Security terminology}
\begin{table}[h!]
\centering
\begin{tabular}{ |p{3cm}|p{8cm}|  }
\hline
...
\subsection{Examples of security terminology (MHC-PMS)}
\begin{table}[h!]
\centering
\begin{tabular}{ |p{3cm}|p{8cm}|  }
\hline
